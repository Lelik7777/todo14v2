...
export const todolistsAPI = {
    ...
    createTodolist: (title: string) => instance.post <{ title: string },
        AxiosResponse<ResponseType<{ item: TodolistType }>>>
    ('todo-lists', {title}),
    deleteTodolist: (id: string) => instance.delete<ResponseType>(`todo-lists/${id}`),
    updateTodolist: (id: string, title: string) =>
        instance.put<{ title: string }, AxiosResponse<ResponseType>>(`todo-lists/${id}`, {title}),
    ...
    createTask: (todolistId: string, title: string) =>
        instance.post<{ title: string }, AxiosResponse<ResponseType<{ item: TaskType }>>>
        (`todo-lists/${todolistId}/tasks`, {title}),
    updateTask: (todolistId: string, taskId: string, model: UpdateTaskModelType) =>
        instance.put<UpdateTaskModelType, AxiosResponse<ResponseType<{ item: TaskType }>>>
